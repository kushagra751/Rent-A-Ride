...
![Overall System Flow](./docs/diagrams/overall-system-flow.svg)
...
![User Module Workflow](./docs/diagrams/user-module-workflow.svg)
...
![Database ER Diagram](./docs/diagrams/database-er-diagram.svg)
...
![Login Authentication Flow](./docs/diagrams/login-auth-flow.svg)
...
![CRM Dashboard Overview](./docs/diagrams/crm-dashboard-overview.svg)
