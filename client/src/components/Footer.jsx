        ...
        <div className="w-full">
          <div className="grid  w-full justify-between lg:px-10 sm:flex sm:justify-between md:flex md:grid-cols-1 gap-y-10 pb-10">
            ...
            <div className="grid grid-cols-2 gap-8 sm:mt-4 sm:grid-cols-3 sm:gap-6 ">
              ...
              <div>
                ...
                <FooterLinkGroup col>
                  <FooterLink href="https://github.com/kushagra751">Github</FooterLink>
          ...
          <div className="w-full sm:flex sm:items-center sm:justify-between lg:px-10 ">
            ...
            <div className="mt-4 flex space-x-6 sm:mt-0 sm:justify-center">
              <FooterIcon href="https://www.linkedin.com/in/kushagra751/" icon={BsLinkedin} />
              <FooterIcon href="https://github.com/kushagra751" icon={BsGithub} />
              <FooterIcon href="https://www.instagram.com/kush18._/" icon={BsInstagram} />
              <FooterIcon href="https://x.com/Kushagra_7__" icon={BsTwitter} />
