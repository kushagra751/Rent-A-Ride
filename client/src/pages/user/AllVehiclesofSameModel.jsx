...
const AllVehiclesofSameModel = () => {
  ...
  const visibleVariants = Array.isArray(filterdData) ? filterdData : allVariants;
    ...
    <>
      ...
      <div className=" lg:grid lg:grid-cols-12 gap-x-10 mx-28 justify-between">
        ...
        <div className="col-span-9">
          ...
          {Array.isArray(visibleVariants) && visibleVariants.length > 0 ? (
          <div
    ...
    flex-wrap mt-10"
          >
            ...
            : (
              <CarNotFound
                compact
                title="No matching variants available"
                message="This model is available, but not with the current filters. Clear a few options to unlock more variants."
              />
            )}
