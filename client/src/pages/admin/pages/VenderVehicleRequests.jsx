...
const VenderVehicleRequests = () => {
  ...
  useEffect(() => {
    const fetchVendorRequest = async () => {
      try {
        const res = await fetch(getApiUrl("/api/admin/fetchVendorVehilceRequests"), {
          method: "GET",
        });
        if (!res.ok) {
          console.error(
  ...
  const handleApproveRequest = async (id) => {
    try {
      ...
      const res = await fetch(getApiUrl("/api/admin/approveVendorVehicleRequest"), {
        method: "POST",
        headers: {
  ...
  const handleReject = async (id) => {
    try {
      ...
      const res = await fetch(getApiUrl("/api/admin/rejectVendorVehicleRequest"), {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
